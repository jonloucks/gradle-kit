...
When submitting a [bug report](https://github.com/jonloucks/gradle-kit/issues/new), please provide the following information:
...
For suggesting enhancements or new features, please [open a GitHub Issue](https://github.com/jonloucks/gradle-kit/issues/new) and follow these guidelines:
